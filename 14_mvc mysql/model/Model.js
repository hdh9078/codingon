...
//mysql연결
//createConnection: 단일연결 => 요청할때마다 새로운 연결을 생성
//적은 수의 동시연결이나 단순한 데이터베이스 쿼리일때만 사용
...
const conn = mysql.createPool({
    ...
    database: 'kdt9',
    port: 3306,
    connectionLimit: 30 //최대연결수(기본값은 10)
})
...
//단점
//1. sql 인젝션 공격 취약
//2.문자열에 특수문자가 포함될 경우 오류가 발생할수도 있다.
//prepared Statement
